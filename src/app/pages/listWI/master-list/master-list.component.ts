...
export class MasterListComponent {
  ...
  onSearch() {
    ...
    if (this.searchQuery.trim() === '') {
      ...
      this.displayDocuments = this.dataDocuments.filter((document : any) =>
        document.document_title.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
        document.nama_area.toLowerCase().includes(this.searchQuery.toLowerCase()) 
      );
      this.calculateTotalPages();
    }
  }
