...
@Component({
  selector: 'app-view-filter-supplies',
  templateUrl: './view-filter-supplies.component.html',
  styleUrls: ['./view-filter-supplies.component.scss']
})
export class ViewFilterSuppliesComponent implements OnInit {
  @Output() indicatorStatusChanged: EventEmitter<string> = new EventEmitter(); // Di sini, tipe generic <string> dihapus
  ...
  getBreadCrumbItems() {
    this.breadCrumbItems = [{ label: "FILTER SUPPLIES" }];
  }
