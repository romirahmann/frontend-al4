...
export class MaintenanceComponent {
  ...
  constructor(private apiservice: MaintenanceService, private modalService: NgbModal, private authService: AuthService, private route: ActivatedRoute) { }
  ...
  toRefurbished(partId: number){
    ...
    // console.log("id: " + partId, " data: ", data);
