...
@Component({
  selector: 'app-add-part-can',
  templateUrl: './add-part-can.component.html',
  styleUrls: ['./add-part-can.component.scss']
})
export class AddPartCanComponent {
  // bread crumb items
  ...
  closeModal(){
      ...
      this.router.navigate(['/maintenance-can']);
  }
