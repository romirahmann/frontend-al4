...
@Component({
  selector: 'app-add-output-can',
  templateUrl: './add-output-can.component.html',
  styleUrls: ['./add-output-can.component.scss']
})
export class AddOutputCanComponent {
  // bread crumb items
 ...
 getDataUserLogin(){
   ...
   closeModal(){
     ...
     this.router.navigate(['/detail-part-can', this.partId]);
   }
